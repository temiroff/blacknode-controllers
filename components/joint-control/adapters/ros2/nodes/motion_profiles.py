...
The profile node is transport-neutral even though it is shipped with the ROS 2
joint-control adapter today.  It produces a small canonical contract that any
